...
class PageTool {
    ...
    public function show() {
		...
		//echo uri; http://localhost/shop-ysb/1225/category.php?cat_id=3&page=1
        $parse = parse_url($uri);
        ...
        if(isset($parse['query'])) {
			//$parse['query']=cat_id=3&page=1
            parse_str($parse['query'],$param);
        }
			//$param=['cat_id'=>'2','page'=>'1']
